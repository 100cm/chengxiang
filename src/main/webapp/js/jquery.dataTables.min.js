...
oPaginate:{sFirst:"第一页",sLast:"最后一页",sNext:"下一页",sPrevious:"上一页"},sEmptyTable:"没有数据",sInfo:"显示 _START_ 到 _END_ 共 _TOTAL_ 数据",sInfoEmpty:"显示 0 to 0 of 0 数据",sInfoFiltered:"(从 _MAX_ 数据中查找)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"显示 _MENU_ 数据",sLoadingRecords:"载入",sProcessing:"加载中",sSearch:"查找:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"没有纪录存在"},oSearch:h.extend({},
